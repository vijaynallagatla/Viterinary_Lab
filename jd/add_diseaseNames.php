...
$(document).ready(function() {
    $('#data-table').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "disease/disease_names.php"
    } );
} );

function add_newDiseaseName(){
	
$.post("disease/add_diseaseNames.php",
    {
        disease_name: document.getElementById("new_diseaseName").value,
        disease_desc: document.getElementById("new_diseaseDesc").value
    },
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="add_diseaseNames.php"><svg class="glyph stroked eye"><use xlink:href="#stroked-eye"/></use></svg> Disease</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Disease Names</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Add New Disease Names</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Existing Disease Names</div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="margin-left:50px">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New Disease Name</h4>
        </div>
        <div class="modal-body">
			...
			<div class="row">
				<div class="col-md-3">
					...
					<input class="form-control" id="new_diseaseName" type="text" placeholder="Enter Disease Name" name="name"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6">
					...
					<textarea class="form-control" id="new_diseaseDesc" placeholder="Enter Short Description" cols="8"></textarea>
				</div>
				<div id="result">
				</div>
			</div>
        ...
        <div class="modal-footer">
          <button type="button" onclick="add_newDiseaseName()" class="btn btn-default">Submit</button>
