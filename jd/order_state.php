...
var value = radios.length>0? radios[0].value: null;
	...
	switch(value){
		case "receiptNo" : 
			$.post("sample_results/result_byReceiptNo.php",
			{
		...
		break;
		case "accession" : 
		$.post("sample_results/result_byAccessionNo.php",
			{
		...
		break;
		case "appRefNo"	 : 
		$.post("sample_results/result_byAppRefNo.php",
			{
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="order_state.php"><svg class="glyph stroked blank document"><use xlink:href="#stroked-blank-document"/></svg> Sample Results</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"> Orders Status</h1>
			</div>
		</div><!--/.row-->
