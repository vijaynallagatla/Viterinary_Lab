...
$role=$_SESSION["role"];
$sql = "SELECT L.lab,L.barcode,O.order_id,L.result_status,L.sample_id,S.sample_id,S.species, O.sample_received_date from labs L,sample_entry S,order_entry O where L.result_status=1 AND L.sample_id=S.sample_id AND S.order_id = O.order_id";
