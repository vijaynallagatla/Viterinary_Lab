...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="batch_orders.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Batch Orders</a></li>
									...
									<fieldset>
										...
										<!-- Tests Required -->
											...
											<div class="col-md-6 col-lg-6" >
												<select id="tests0" name="testsRequired[]" style="min-width:400px" class="selectpicker" multiple>
