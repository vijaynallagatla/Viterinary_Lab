...
$document.ready(function(){
	$("#sample_fromState").onChange(function(){
		$.post("listPlaces.php",
    {
        state: document.getElementById("sample_fromState").value
    },
    function(data, status){
		document.getElementById("sample_fromPlace").innerHTML=data;
    });
	});
});
*/
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="add_testnames.php"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></use></svg> Tests</a></li>
			<li><a href="add_disease.php"><svg class="glyph stroked eye"><use xlink:href="#stroked-eye"/></use></svg> Disease</a></li>
						...
						<form class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-3">
									<select class="form-control" name="sample_fromState" id="sample_fromState" placeholder="Select State">
									...
									<div class="col-md-3">
									<select name="sample_fromPlace" id="sample_fromPlace" type="text" placeholder="Select Place" class="form-control">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<textarea id="sample_place" class="form-control" name="sample_place">
								...
								<form class="form-horizontal">
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-3"> 	
											<input name="animalAge[]"  type="text" placeholder="Enter Age of Animal" class="form-control">
											</div>
