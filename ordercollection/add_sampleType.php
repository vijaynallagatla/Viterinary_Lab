...
$(document).ready(function() {
    $('#data-table').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "sampleType/sampleType.php"
    } );
} );

function add_newSampleType(){
	
$.post("sampleType/add_sampleType.php",
    {
        sample_type: document.getElementById("new_sampleType").value,
        sample_desc: document.getElementById("new_sampleDesc").value
    },
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="add_sampleType.php"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad"/></use></svg> Sample Type</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Add Sample Types</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				...
				<a href="#addSampleType" data-toggle="modal" data-target="#addSampleType">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Existing Samples</div>
	...
	<!-- Modal -->
  <div class="modal fade" id="addSampleType" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="margin-left:50px">
	 
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Add New Sample Type</h4>
        </div>
        <div class="modal-body">
          
			<div class="row">
				<div class="col-md-3">
					<label>Species Type <span style="color:red">*</span></label><br/>
					<input class="form-control" id="new_sampleType" type="text" placeholder="Enter New Sample Type" name="name"/>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6">
					...
					<textarea class="form-control" id="new_sampleDesc" placeholder="Enter Short Description (Optional)" cols="8"></textarea>
				</div>
				<div id="result">
				</div>
			</div>
        ...
        <div class="modal-footer">
          <button type="button" onclick="add_newSampleType()" class="btn btn-default">Submit</button>
