...
$row = $result->fetch_assoc();
		...
		$str .= '<div class="row" style="margin-top:15px;margin-right:10px">
					<div class="col-md-6">
						<div class="col-md-6">
							<label><b>Tests Performed : </b></label>
						</div>
						<div class="col-md-6">
							<select class="selectpicker" data-width="100%" id="testsPerformed" multiple>' . $options . ' </select>
						</div>
					</div>
			<div class="form-group col-md-6">
				<div class="col-md-6">
					<label class="control-label">Tests Performed Date :</label>
				</div>
				<div class="col-md-6">
					<div class="input-group date" data-provide="datepicker">
						<input id="tests_performed_date" type="text" class="form-control">
		...
		<div class="col-md-6"><label><b>Select the Results Format : &nbsp; &nbsp; </b></label><select class="selectpicker" onchange="getFormat(this)"  id="result_format">' . $format . '</select></div></div>';
		$str .= '<script>
				...
				<div class="container-fluid" style="margin-right:10px">
					<div class="row">
						<div class="col-lg-12 nopadding">
							<textarea style="overflow:scroll" id="sampleResults"></textarea> 
						</div>
					</div>
				</div>
			</div>
