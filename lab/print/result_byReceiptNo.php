...
if ($conn->connect_error) {
	...
	$sql = "SELECT * from order_entry O,sample_entry S, labs L where O.cm_receipt_number='" . $rNo . "' AND O.order_id=S.order_id AND L.sample_id=S.sample_id AND lab='" . $lab . "'";
