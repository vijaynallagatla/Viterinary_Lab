...
$.post( "resultFormatData.php", function( data ) {
  _el("sampleFormat").innerHTML=data;
});


function viewFormat(format_id){
	$.post( "viewResultFormat.php?format_id="+format_id, function( data ) {
		bootbox.alert({ 
		  size: "large",
		  message: data, 
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<li class="active"><a href="sample_result_format.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Report Result Format</a></li>
